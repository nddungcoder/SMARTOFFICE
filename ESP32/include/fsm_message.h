...
/// @brief Các trạng thái của máy trạng thái hữu hạn (FSM) dùng để phân tích frame UART
typedef enum {
 ...
 * @param dataout Mảng dùng để lưu toàn bộ frame nếu nhận thành công.
 */
 ...
 * 
 * Gọi hàm này sau khi đã xử lý xong một frame hợp lệ, để FSM sẵn sàng nhận frame tiếp theo.
 */
